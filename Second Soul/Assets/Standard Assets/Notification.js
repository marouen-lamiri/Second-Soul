...
var onScreenTime:float=3;//Default 4 //Change this to modify the number of seconds each notification remains on screen
//Increase the following variable to speed up thye fade out. Set to 1 to snap the notification from view.
var fadeOutSpeed:float=0.01;//Default 0.02
...
var position_x:float=Screen.width/4*3;//Default 0. By default the bar goes all the way across the screen but you can make it smaller!
var box_width:float=Screen.width/4;//By default the bar goes all the way across the screen but you can make it smaller!
